    ...
    return (
        ...
        <div
            ...
            <div className='flex bg-gray-100 justify-end gap-4 items-center h-15'>
                ...
                className={newBlogState === 'edit' ? 'text-gray-600  cursor-pointer font-bold':'text-gray-600 cursor-pointer'}>Edit</div>
                <div 
                onClick={()=>setNewBlogState('preview')}
                className={newBlogState === 'preview' ? 'text-gray-600  cursor-pointer font-bold':'text-gray-600 cursor-pointer'}>Preview</div>
                <div>
                    <IoMdClose
                        onClick={() => navigate(-1)}
...
<div>
 ...
 <div className='p-4 '>
                ...
                <div className='font-bold text-2xl my-4'>{blogTitle}</div>
                <div className='flex gap-4 text-[14px] text-gray-500'>
                    {blogTags.map((tag) => (
                        <p key={tag}>#{tag}</p>
                    ))}
                </div>
                <div className='flex gap-4 mb-4 h-5 border-b border-gray-200'>
                </div>
                <div
